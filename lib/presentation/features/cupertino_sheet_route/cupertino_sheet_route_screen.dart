...
import 'widgets/cupertino_sheet_route_body.dart';

@RoutePage()
class CupertinoSheetRouteScreen extends StatelessWidget {
  const CupertinoSheetRouteScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const AppGradientScaffold(
      appBar: CommonAppBar(title: "CupertinoSheetRoute"),
      body: CupertinoSheetRouteBody(),
    );
  }
}
