...
mixin _$HomeItemModel {
 ...
 String get title;@JsonKey(includeFromJson: false, includeToJson: false) IconData? get icon;@JsonKey(includeFromJson: false, includeToJson: false) PageRouteInfo<Object?>? get route;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeItemModel&&(identical(other.title, title) || other.title == title)&&(identical(other.icon, icon) || other.icon == icon)&&(identical(other.route, route) || other.route == route));
}
...
@override
String toString() {
  return 'HomeItemModel(title: $title, icon: $icon, route: $route)';
}
...
@useResult
$Res call({
 String title,@JsonKey(includeFromJson: false, includeToJson: false) IconData? icon,@JsonKey(includeFromJson: false, includeToJson: false) PageRouteInfo<Object?>? route
});
...
/// Create a copy of HomeItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? icon = freezed,Object? route = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title, @JsonKey(includeFromJson: false, includeToJson: false)  IconData? icon, @JsonKey(includeFromJson: false, includeToJson: false)  PageRouteInfo<Object?>? route)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeItemModel() when $default != null:
return $default(_that.title,_that.icon,_that.route);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title, @JsonKey(includeFromJson: false, includeToJson: false)  IconData? icon, @JsonKey(includeFromJson: false, includeToJson: false)  PageRouteInfo<Object?>? route)  $default,) {final _that = this;
switch (_that) {
case _HomeItemModel():
return $default(_that.title,_that.icon,_that.route);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title, @JsonKey(includeFromJson: false, includeToJson: false)  IconData? icon, @JsonKey(includeFromJson: false, includeToJson: false)  PageRouteInfo<Object?>? route)?  $default,) {final _that = this;
switch (_that) {
case _HomeItemModel() when $default != null:
return $default(_that.title,_that.icon,_that.route);case _:
  return null;
...
class _HomeItemModel implements HomeItemModel {
  const _HomeItemModel({required this.title, @JsonKey(includeFromJson: false, includeToJson: false) this.icon, @JsonKey(includeFromJson: false, includeToJson: false) this.route});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeItemModel&&(identical(other.title, title) || other.title == title)&&(identical(other.icon, icon) || other.icon == icon)&&(identical(other.route, route) || other.route == route));
}
...
/// Create a copy of HomeItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? icon = freezed,Object? route = freezed,}) {
